...
export default function TodayView() {
  ...
  function exportData() {
    ...
    a.href = url;
    a.download = `daytask-${selectedDate}.json`;
    a.click();
    ...
    <>
      ...
      <div className="view-topbar">
        ...
        <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
          ...
          <button className="icon-btn" title="Xuất dữ liệu" onClick={exportData}>
            <IconDownload size={16} />
          </button>
          <button className="icon-btn" title="Tìm kiếm" onClick={() => {}}>
            <IconSearch size={16} />
          </button>
          <button className="icon-btn" title="Thêm task" onClick={openAdd}>
            <IconPlus size={16} />
          </button>
        </div>
      </div>
      ...
      <div className="view-content">
        ...
        {total > 0 && (
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <span style={{ fontSize: 12, color: 'var(--text-secondary)', flexShrink: 0 }}>{pct}%</span>
          </div>
        )}
        ...
        {total === 0 && (
          <div style={{ textAlign: 'center', color: 'var(--text-secondary)', padding: '40px 0' }}>
            <IconSun style={{ fontSize: 32, marginBottom: 8, display: 'block', margin: '0 auto 8px' }} />

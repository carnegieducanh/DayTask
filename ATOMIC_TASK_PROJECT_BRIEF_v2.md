# atomic_task — Project Brief v2

**Tech stack: Tauri + React + TypeScript + SQLite**

> Paste file này vào Claude Code trong VSCode và nói:
> **"Đọc file ATOMIC_TASK_PROJECT_BRIEF_v2.md và bắt đầu xây dựng app theo đúng spec, làm từng bước theo thứ tự build ở phần cuối file."**
...
#   └── msi/atomic_task_x.x.x_x64_en-US.msi   ← installer
#   └── nsis/atomic_task_x.x.x_x64-setup.exe  ← installer nhỏ hơn
```
...
```
Đọc file ATOMIC_TASK_PROJECT_BRIEF_v2.md và bắt đầu xây dựng app atomic_task.
Tech stack: Tauri v2 + React + TypeScript + SQLite.
Bắt đầu từ Bước 1: khởi tạo project bằng lệnh:
  npm create tauri-app@latest atomic_task -- --template react-ts

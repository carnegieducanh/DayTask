export const vi = {
  ...
  settings: {
    ...
    exporting: "Đang xuất...",
    backupHint: "File backup bao gồm toàn bộ dữ liệu: tasks, mục tiêu, checklist, khung giờ, màu danh mục, tags, nhật ký, checklist tuần, từ vựng, quotes và sách (kể cả ảnh bìa).",
    language: "Ngôn ngữ",
    importConfirm:

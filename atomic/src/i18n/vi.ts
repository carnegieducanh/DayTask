export const vi = {
  ...
  journal: {
    ...
    lessonPrompt: [
      'Ghi lại một bài học hôm nay theo 3 phần:',
      'Sự kiện · Tâm đắc · Ngộ ra',
    ],
    lessonPlaceholder: 'Bài học tôi ngộ ra hôm nay là...',
    lessonFields: [
      { label: 'Sự kiện', prompt: 'Điều gì đã xảy ra?', placeholder: 'Mô tả sự kiện diễn ra...' },
      { label: 'Tâm đắc', prompt: 'Điều gì khiến bạn ấn tượng hoặc đáng ghi nhớ?', placeholder: 'Điều tôi chú ý là...' },
      { label: 'Ngộ ra', prompt: 'Nguyên lý hoặc chân lý tổng quát hơn mà bạn rút ra.', placeholder: 'Bài học tôi rút ra là...' },
    ],
